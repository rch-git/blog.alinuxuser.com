...
This is the perfect 6/10 game. There are flashes of brilliance, but everything is just done by the numbers.

I played this on PC (i7-4700K, GTX 1070 Ti, Windows 10). It ran fine on my 1920x1200 monitor and was widescreen-compatible from the get-go. I didn't run into any technical issues or bugs; the kind of framerate problems that are still common in console ports even today. This is one of those ports that isn't a complete mess. The Uncaged Edition is the way to experience this game; I believe it's the only edition available on PC. I streamed it on Twitch, and at one point I think I was the only person in the world playing it, which I found interesting.

The console-centric design is obvious. You get the usual suspects: repetitive level and enemy design, quick-time events, and shallow RPG elements that exist mainly to pad playtime. It's not terrible. You choose what to upgrade and unlock some moves and abilities. It's a very violent game, and once the moves unlocked, there's some real fun to be had. A few combat sequences and finishing moves are fantastic. If the developers had gone for a more immersive design instead of falling back on by-the-numbers choices, this could have been an amazing game.
